...
Note that the released DMG file has only been tested with the latest macOS release. Support for older versions shall be provided in the future (see issue [119](https://github.com/tobias-klein/ezra-project/issues/119)).
