...
Note that on Windows versions before Windows 10 you need to install the <a href="https://www.microsoft.com/en-us/download/details.aspx?id=53840">Microsoft Visual C++ 2015 Redistributable</a> package. Please pick the file vc_redist.x86.exe once you're asked to choose the specific download.
